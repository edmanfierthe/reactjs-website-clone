        ...
        <form >
            ...
            <div className="flex items-center mb-6">
                <div>
                    ...
                    <div className="flex w-full justify=center items-center space-x-6">
                        ...
                        min="50" max="40000000" required className="x-full px-4 py-2 text-xl text-gray-700 bg-white
            ...
            {offer && (
                ...
                <div>
                    ...
                    <div className="flex w-full justify=center items-center space-x-6">
                        <input type="number" id="discountedPrice" value={discountPrice} onChange={onChange} 
                        min="50" max="40000000" required={offer} className="x-full px-4 py-2 text-xl text-gray-700 bg-white
                        border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 
                        focus:bg-white focus:border-slate-600 text-center"/>
