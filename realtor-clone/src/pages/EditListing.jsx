...
export default function CreateListing() {
    ...
    const {type, name, bedrooms, bathrooms, parking, furnished, address, description, offer, 
    ...
    async function onSubmit(e){
        ...
        //Toast error when discount < regular price
        if(+discountedPrice >= +regularPrice){
            setLoading(false)
            toast.error("Discounted price needs to be less than regular price")
            return;
        }
        // Toast error when max images > 6
        if (images.length > 6){
            setLoading(false)
            toast.error("Maximum of images is 6")
            return;
        }
    ...
    <main className="max-w-md px-2 mx-auto">
        ...
        <form  onSubmit={onSubmit}>
            ...
            <div className="flex">
                ...
                className={` mr-3 px-7 py-3 font-medium text-sm uppercase shadow-medium rounded
                hover:shadow-lg focus:shadow-lg active:shadow-lg transition duration 
                ease-in-out w-full ${
                ...
                className={`ml-3 px-7 py-3 font-medium text-sm uppercase shadow-medium rounded
                hover:shadow-lg focus:shadow-lg active:shadow-lg transition duration 
                ease-in-out w-full ${
            ...
            className="w-full px-4 py-2 text-xl text-gray-600 bg-white border border-gray-300
            rounded transition-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600
            mb-6" />
            <div className="flex space-x-6 mb-6">
                <div>
                    <p className="w-full text-lg font-semibold">Beds</p>
                    <input type="number" value={bedrooms} id="bedrooms" 
                    onChange={onChange} min="1" max="50" required  className="px-4 py-2 text-xl text-gray-700
                ...
                <div>
                    ...
                    <input type="number" value={bathrooms} id="bathrooms" 
                    onChange={onChange} min="1" max="50" required  className="px-4 py-2 text-xl text-gray-700
                    bg-white border border-gray-300 rounded transition duration-150 ease-in-out
                    focus:text-gray-700 focus:bg-white focus:border-slate-600 text center"/>
                </div>
            </div>
            <p className="text-lg mt-6 font-semibold">Parking Garage</p>
            <div className="flex">
            ...
            <div className="flex items-center mb-6">
                <div>
                    ...
                    <div className="flex w-full justify=center items-center space-x-6">
                        ...
                        min="50" max="400000000" required className="x-full px-4 py-2 text-xl text-gray-700 bg-white
            ...
            {offer && (
                ...
                <div>
                    ...
                    <div className="flex w-full justify=center items-center space-x-6">
                        ...
                        min="50" max="400000000" required={offer} className="x-full px-4 py-2 text-xl text-gray-700 bg-white
                        border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 
                        focus:bg-white focus:border-slate-600 text-center"/>
            ...
            <div className="mb-6">
                ...
                multiple required className="w-full px-3 py-1.5 text-gray-700 bg-white border 
                border-gray-600 rounded transition duration-150 ease-in-out
            ...
            active:shadow-lg transition duration-150 ease-in-out">Edit Listing</button>
        </form>
    </main>
  )
}
