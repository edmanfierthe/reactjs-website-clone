...
import {doc, orderBy, query, updateDoc, where, getDocs, collection} from "firebase/firestore"
      ...
      <section className='max-w-6xl mx-auto flex justify-center items-center flex-col'>
        ...
        <div className='w-full md:w-[50%] mt-6 px-3'>
          <form action="">
            ...
            onChange={onChange} className={`mb-6 w-full px-4 py-2 text-xl text-gray-700
            bg-white border-gray-300 rounded transition ease-in-out ${changeDetail && "bg-red-200 focus:bg-red-200"}`} />
